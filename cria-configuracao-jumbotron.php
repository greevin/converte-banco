...
"", 
0, 
"'.$url.'?post_type=configuracoes_tema&#038;p=453", 
0, 
"configuracoes_tema", 
"", 
0);
...
VALUES (453, "jumbotron_titulo", "Núcleo de Informática Aplicada à Educação");
';
...
$jumbotron_subtitle = '
INSERT INTO wp_db_postmeta (post_id, meta_key, meta_value)
VALUES (453, "jumbotron_subtitulo", "A missão do NIED é difundir conhecimento sobre as relações entre a educação, a sociedade e a tecnologia por meio de pesquisas e desenvolvimento de tecnologias e metodologias de forma integrada às demandas da sociedade.");
';
...
$jumbotron_button = '
INSERT INTO wp_db_postmeta (post_id, meta_key, meta_value)
VALUES (453, "texto_do_botao", "Saiba Mais");
';
